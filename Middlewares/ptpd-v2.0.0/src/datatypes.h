...
/**
 * \brief 5.3.3 The Timestamp type represents a positive time with respect to
 * the epoch
 */
...
/**
 * \brief 5.3.6 The PortAdress type represents the protocol address of a PTP
 * port
 */
...
/**
 * \brief 5.3.9 The PTPText data type is used to represent textual material in
 * PTP messages textField - UTF-8 encoding
 */
...
typedef struct
{
    ...
    TimeInternal
         timestamp_delayReqSend;        /**< timestamp of delay request message */
    TimeInternal
         timestamp_delayReqRecieve;     /**< timestamp of delay request message */

    TimeInternal correctionField_sync;  /**< correction field of Sync and FollowUp
                                                      messages */
    TimeInternal correctionField_pDelayResp; /**< correction fieald of peedr
                                                              delay response */
    ...
    bool waitingForFollowUp; /**< true if sync message was recieved and 2step
                                         flag is set */
    bool waitingForPDelayRespFollowUp; /**< true if PDelayResp message was
                                                      recieved and 2step flag is set */
